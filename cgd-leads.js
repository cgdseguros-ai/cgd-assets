...
(function(){
  ...
  // =========================
  // Audio — 3 beeps (opção 3) + unlock estável
  // =========================
  ...
  function playLeadAlertFallback(){
    try{
      ...
      leadBeep(ctx, base + 0.00, 740, 0.11, 0.16, "triangle");
      leadBeep(ctx, base + 0.17, 880, 0.11, 0.16, "triangle");
      leadBeep(ctx, base + 0.34, 1174, 0.18, 0.16, "triangle");
    }catch(_){ }
  }
