...
(function(){
  ...
  // =========================
  // Audio — 3 beeps agradáveis e altos + unlock reforçado
  // =========================
  ...
  function leadBeep(ctx, t, freq=1000, dur=0.10, gainLevel=0.30){
    ...
    g.gain.exponentialRampToValueAtTime(gainLevel * 0.72, t + Math.max(0.04, dur - 0.03));
  ...
  function playLeadAlertFallback(){
    try{
      ...
      const fire = ()=>{
        ...
        leadBeep(ctx, base + 0.00, 980, 0.10, 0.31);
        leadBeep(ctx, base + 0.21, 1000, 0.10, 0.31);
        leadBeep(ctx, base + 0.42, 1040, 0.11, 0.33);
      };
