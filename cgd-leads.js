...
(function(){
  ...
  // =========================
  // Paper plane animation — AMARELO ~15cm
  // =========================
  function flyPlaneYellow(){
    try{
      ...
      d.innerHTML = `
        <svg viewBox="0 0 320 200" width="540" height="540" aria-hidden="true">
          <defs>
...
@keyframes planeFly{
  ...
  10%  { opacity: .98; }
  100% { transform: translateX(calc(100vw + 1040px)) rotate(-8deg); opacity: 0; }
}
