...
(function(){
  ...
  // =========================
  // Audio — 3 beeps (opção 2) + unlock estável
  // =========================
  ...
  function leadBeep(ctx, t, freq=950, dur=0.10, gainLevel=0.12, type="square"){
  ...
  function playLeadAlertFallback(){
    try{
      ...
      leadBeep(ctx, base + 0.00, 950, 0.10, 0.12, "square");
      leadBeep(ctx, base + 0.15, 1100, 0.10, 0.12, "square");
      leadBeep(ctx, base + 0.30, 1350, 0.14, 0.12, "square");
    }catch(_){ }
  }
